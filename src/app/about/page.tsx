...
export default function About() {
    return(
        <div className="relative w-screen h-screen md:h-[110vh] lg:h-[110vh] flex justify-center">
            <GravityStarsBackground 
                starsCount={100}
                starsOpacity={0.50}
                className="h-screen w-screen"
            />
            <div className="absolute flex w-[80vw] ml-5 mr-5 pt-30 md:pt-25 md:w-[50vw] md:ml-20 md:mr-20 lg:ml-80 lg:mr-80">
                <div className="absolute flex flex-col border-transparent rounded-2xl bg-fucoraCards p-3 md:p-8 lg:p-10">
